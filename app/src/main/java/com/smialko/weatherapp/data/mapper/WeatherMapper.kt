...
import com.smialko.weatherapp.data.network.dto.WeatherCurrentDto
import com.smialko.weatherapp.data.network.dto.WeatherDto
import com.smialko.weatherapp.data.network.dto.WeatherForecastDto
...
fun WeatherForecastDto.toEntity() = Forecast(
    ...
    upcoming = forecastDto.forecastDay.drop(1).map { dayDto ->
        val dayWeatherDto = dayDto.datWeatherDto
        Weather(
