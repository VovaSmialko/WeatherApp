...
import com.smialko.weatherapp.domain.entity.usecase.GetForecastUseCase
import com.smialko.weatherapp.domain.entity.usecase.ObserveFavouriteStateUseCase
import com.smialko.weatherapp.presentation.details.DetailsStore.Intent
import com.smialko.weatherapp.presentation.details.DetailsStore.Label
import com.smialko.weatherapp.presentation.details.DetailsStore.State
...
internal interface DetailsStore : Store<Intent, State, Label> {
    ...
    sealed interface Intent {
        ...
        data object ClickChangeFavouriteState : Intent
    }
    ...
    private inner class ExecutorImpl : CoroutineExecutor<Intent, Action, State, Msg, Label>() {
        override fun executeIntent(intent: Intent, getState: () -> State) {
            when (intent) {
                ...
                Intent.ClickChangeFavouriteState -> {
                    scope.launch {
                        val state = getState()
